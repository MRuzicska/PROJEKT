            ...
            <tr>
              ...
              <td>
                <form method="post" class="button-row" style="margin-top:0;">
                  ...
                  <select name="status"
                    style="padding:10px 12px;border-radius:10px;border:1px solid #4b6473;background:#122b3a;color:#fff;">
                  ...
                  <a href="order_edit.php?id=<?= $o['id'] ?>" class="btn-primary">Szerkesztés</a>
                </form>
              </td>
            </tr>
          <?php endforeach; ?>
